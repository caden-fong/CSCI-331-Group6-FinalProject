            ...
            <div className="col- mor">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/Dungeons-Dragons-Monster-Rulebook-Roleplaying/dp/0786965614/ref=sr_1_3?crid=2HPWYNBEXLCB8&keywords=d%26d+dm+guide&qid=1638239958&sprefix=d%26d+dm%2Caps%2C401&sr=8-3" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
            <div className="col- mor">
              <div className="card">
                ...
                <div className="card-body">
                  ...
                  <p className="card-text">(Core Rulebook, D&D Roleplaying Game)</p>
                  <a href="https://www.amazon.com/Dungeons-Dragons-Dungeon-Rulebook-Roleplaying/dp/0786965622/ref=sr_1_1?crid=2HPWYNBEXLCB8&keywords=d%26d+dm+guide&qid=1638239958&sprefix=d%26d+dm%2Caps%2C401&sr=8-1" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
          </div>
            ...
            <div className="col- mor">
              <div className="card car">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/Curse-Strahd-Revamped-Premium-Dungeons/dp/0786967153/ref=sr_1_13?crid=2HPWYNBEXLCB8&keywords=d%26d+dm+guide&qid=1638239958&sprefix=d%26d+dm%2Caps%2C401&sr=8-13" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
            <div className="col- mor">
              <div className="card car">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/Dungeons-Dragons-Rulebooks-Slipcase-Handbook/dp/0786966629/ref=sr_1_2?crid=2HPWYNBEXLCB8&keywords=d%26d+dm+guide&qid=1638239958&sprefix=d%26d+dm%2Caps%2C401&sr=8-2" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
            <div className="col- mor">
            ...
            <div className="col- mor">
              <div className="card car2">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/Dungeon-Kit-DMs-Guide/dp/B0955CDWSW/ref=sr_1_6?crid=2HPWYNBEXLCB8&keywords=d%26d+dm+guide&qid=1638239958&sprefix=d%26d+dm%2Caps%2C401&sr=8-6" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
            <div className="col- mor">
              <div className="card car2">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/Double-Colors-Polyhedron-Dungeons-Dragons-Flannel/dp/B08VD4Q7XW/ref=sr_1_5?keywords=d%26d+dice&qid=1638240526&sr=8-5" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
            <div className="col- mor">
              <div className="card car2">
                ...
                <div className="card-body">
                  ...
                  <a href="https://www.amazon.com/CiaraQ-Polyhedral-Double-Colors-Dungeons-Pathfinder/dp/B0794Z8XRP/ref=sr_1_omk_6?keywords=d%26d+dice&qid=1638240614&sr=8-6" className="btn btn-dark stretched-link">Shop Amazon</a>
                </div>
              </div>
            </div>
          </div>
